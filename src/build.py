...
first_name = "Tegar"
last_name = "Andriyansyah"
name = f"{first_name} {last_name}"
domain = "tegar-andri.vercel.app"
generic_username = "g4rrzx"
...
seo_common = {
    "url": url,
    "title": name,
    "description": f"Portfolio of {name} — Informatics Engineering student passionate about AI, Automation, and Blockchain.",
